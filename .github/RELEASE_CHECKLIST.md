...
- The 2026-07-28 MCP protocol catalog is compared before/after Desktop MCP listener restart: all 221 default descriptors and their canonical SHA-256 digest must remain identical, and a production tool call must work on both sides of the restart.
...
- Tool catalog synchronization passes with 227 configurable tools and 221 advertised by default; the six `codex_*` delegation tools remain opt-in.
