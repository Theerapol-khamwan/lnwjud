...
**Current version:** `v4.11.0` - Windows installer `lnwjud-Setup-4.11.0.exe` and portable executable `lnwjud-Portable-4.11.0.exe`; MCP registry **223 configurable tools / 217 advertised by default**.
