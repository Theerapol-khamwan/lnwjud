...
const th: NativeMessages = {
  ...
  updaterInstallWaiting: 'กำลังรอให้งานที่ใช้งานอยู่เสร็จ จากนั้นจะหยุด Secure Tunnel และติดตั้งอัปเดต…',
...
const en: NativeMessages = {
  ...
  updaterInstallWaiting: 'Waiting for active work to finish, then Secure Tunnel will stop and the update will install…',
