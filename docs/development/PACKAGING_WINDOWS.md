...
`apps/desktop/electron-builder.yml` is the source of truth. The current v4.51.0 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-4.51.0.exe.blockmap
