...
`apps/desktop/electron-builder.yml` is the source of truth. The current v4.8.31 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-4.8.31.exe.blockmap
