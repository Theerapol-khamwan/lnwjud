...
current v4.44.0 runtime contract is 231 total definitions, 195 advertised by
default, and 202 when Codex delegation plus Agent Swarm is enabled; see the current catalog and
